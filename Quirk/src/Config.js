...
Config.GATE_FILL_COLOR = "#33B1FF";
Config.HIGHLIGHTED_GATE_FILL_COLOR = "#33B1FF";
Config.TIME_DEPENDENT_HIGHLIGHT_COLOR = "#9679eb";

// Mixed-state displays are green.
Config.DISPLAY_GATE_IN_TOOLBOX_FILL_COLOR = "#3ECD35";
Config.DISPLAY_GATE_BACK_COLOR = "white";
Config.DISPLAY_GATE_FORE_COLOR = "#3ECD35";

// Changes are yellow.
Config.OPERATION_BACK_COLOR = "#edfeff";
Config.OPERATION_FORE_COLOR = "#33B1FF";

// Pure-state displays are cyan.
Config.SUPERPOSITION_BACK_COLOR = '#EFF';
Config.SUPERPOSITION_MID_COLOR = '#0FF';
...
Config.WIRE_SPACING = 40;

Config.BACKGROUND_COLOR = "white";
Config.BACKGROUND_COLOR_CIRCUIT = "white";

// Toolbox layout.
Config.BACKGROUND_COLOR_TOOLBOX = "#C6EDFF";
...
// Draw constants.
Config.DEFAULT_FILL_COLOR = "#c4e9ff";
Config.DEFAULT_STROKE_COLOR = "black";
Config.DEFAULT_TEXT_COLOR = "#3C3C3C";
Config.DEFAULT_FONT_SIZE = 12;
Config.DEFAULT_FONT_FAMILY = "Helvetica Neue";
...
// Actualmente tienes:
Config.TOOLBOX_GROUP_SPACING = 40;   // separación horizontal entre grupos
Config.TOOLBOX_GATE_SPACING = 2;         // separación entre puertas dentro de un grupo
// Añade una constante para el padding extra que usas
Config.TOOLBOX_LABEL_PADDING = 0;  
