...
let POST_SELECT_DRAWER = args => {
    ...
    if (!args.isInToolbox) {
        ...
        args.painter.print("post-", x + w / 2, y, 'center', 'hanging', 'red', '10px Helvetica Neue', w, h / 2);
        args.painter.print("select", x + w / 2, y + h, 'center', 'bottom', 'red', '10px Helvetica Neue', w, h / 2);
    }
};
